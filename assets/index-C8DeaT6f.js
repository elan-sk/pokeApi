...
`;function z1({src:o,link:a}){const f=["Logo","text-center text-lg-end flex-grow-0 mt-5 mt-lg-0",a?"Logo--link":""].join(" ");return j.jsx("div",{className:f,children:j.jsxs(T1,{direction:"up",duration:1e3,triggerOnce:!0,children:[a&&j.jsx("a",{href:a,target:"_blank",children:j.jsx("img",{src:o,alt:"Logo empresarial"})}),!a&&j.jsx("img",{src:o,alt:"Logo empresarial"})]})})}function j1(){return j.jsx(j.Fragment,{children:j.jsx("div",{className:"container",children:j.jsxs("div",{className:"row",children:[j.jsxs("div",{className:"col-lg-7",children:[j.jsx(eh,{}),j.jsxs(pf,{children:[j.jsx(Ot,{path:"/pokeApi",element:j.jsx(Ef,{})}),j.jsx(Ot,{path:"/pokeApi/pokemon/:id",element:j.jsx(Ef,{})}),j.jsx(Ot,{path:"/pokeApi/favoritos",element:j.jsx(kf,{})}),j.jsx(Ot,{path:"/pokeApi/favorito/:id",element:j.jsx(kf,{})}),j.jsx(Ot,{path:"/pokeApi/*",element:j.jsx(ah,{})})]}),j.jsx(z1,{src:"./logo-elan-sk.svg",link:"https://elan-sk.github.io/"})]}),j.jsx("div",{className:"col-lg-5",children:j.jsxs(pf,{children:[j.jsx(Ot,{path:"/pokeApi/",element:j.jsx(gi,{})}),j.jsx(Ot,{path:"/pokeApi/pokemon/:id",element:j.jsx(gi,{})}),j.jsx(Ot,{path:"/pokeApi/favoritos",element:j.jsx(gi,{})}),j.jsx(Ot,{path:"/pokeApi/favorito/:id",element:j.jsx(gi,{})})]})})]})})})}bm.createRoot(document.getElementById("root")).render(j.jsx(Fm,{children:j.jsx(Zm,{children:j.jsx(j1,{})})}));
